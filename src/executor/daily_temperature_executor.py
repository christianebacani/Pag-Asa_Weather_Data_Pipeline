...
from ingest.daily_temperature import extract_lowest_temperature_recorded_date
...
def ingest_daily_temperature(
    ...
    lowest_temperature_recorded_date = extract_lowest_temperature_recorded_date(soup)